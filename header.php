...
<!--20170529_yokoi_ADD_START-->
<!--サーチコンソールのmetaデータ-->
<meta name="google-site-verification" content="piPEFr9BSyMFbKHHFO2Bc_-0tFdGLxBhO1fi2WzK5lI" />
<!--20170529_yokoi_ADD_END-->
...
<!--20170626_yokoi_ADD_START-->
<!--Google AdSenseコード-->
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-1238106278490188",
    enable_page_level_ads: true
  });
</script>
<!--20170626_yokoi_ADD_END-->
...
<div id="inner-header" class="wrap cf">
  ...
  <?php if ( get_theme_mod( 'opencage_logo' ) ) : ?>
    ...
    <h1 class="h1 img">
      <a href="<?php echo home_url(); ?>" rel="nofollow"><img src="<?php echo get_theme_mod( 'opencage_logo' ); ?>" alt="<?php bloginfo('name'); ?>"></a>
    </h1>
  ...
  <?php if ( get_theme_mod( 'opencage_logo' ) ) : ?>
  <p class="h1 img">
    <a href="<?php echo home_url(); ?>"><img src="<?php echo get_theme_mod( 'opencage_logo' ); ?>" alt="<?php bloginfo('name'); ?>"></a>
  </p>
  <?php else : ?>
